 ...
 * @author ：努力吧小朱.
 * @version : Java1.8
 * @date ：Created in 17:15 2019/7/24
 * @ Description：${description}
 * @ Modified By：
 */
public class DeadlineCorrect {
    ...
    private String fire_safety_behavior;
    ...
    public String getFire_safety_behavior() {
        return fire_safety_behavior;
    }

    public void setFire_safety_behavior(String fire_safety_behavior) {
        this.fire_safety_behavior = fire_safety_behavior;
    }

    public String getRectification_deadline() {
        return rectification_deadline;
    }


    public void setRectification_deadline(String rectification_deadline) {
        this.rectification_deadline = rectification_deadline;
    }

    public static class FireSafetyBehaviorBean {
        /**
         * value : 1
         * text : 消防设计、竣工。。。
         */
